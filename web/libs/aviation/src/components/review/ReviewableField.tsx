      ...
      {currentStatus !== 'pending' && (
        <div className={styles.persistentBadge}>
          {currentStatus === 'approved' && (
            <span className={`${styles.badge} ${styles.badgeApproved}`} title={t('review.approved_status')}>
          ...
          {currentStatus === 'rejected' && (
            <span className={`${styles.badge} ${styles.badgeRejected}`} title={t('review.rejected_status')}>
              <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor">
          ...
          {currentStatus === 'revision' && (
            <span className={`${styles.badge} ${styles.badgeRevision}`} title={t('review.badge.needs_revision')}>
              <svg width="10" height="10" viewBox="0 0 16 16" fill="currentColor">
